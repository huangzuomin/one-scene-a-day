...
> 处置：删旧建新。每日自动化已由 09-06 夜会话重建；周日 Learning 已由 09-06 深夜会话按本档 §2 重建，
> 事故处置闭环，本档转为两份提示词的长期事实源。

## 1. 每日创作流水线（21:00 每日）

- cron：`0 21 * * *`
- 现状：⏸️ 已暂停删除（2026-09-15 用户指令「暂停项目自动运行」；恢复时由本会话重建即可，提示词照抄下文）
...
- cron：`0 10 * * 0`
- 现状：✅ automation-0fa3d6b3-41ac-407c-b1ff-63270b3b2ed6（2026-09-06 22:19 重建，已生效；下次触发 2026-09-13 10:00）
